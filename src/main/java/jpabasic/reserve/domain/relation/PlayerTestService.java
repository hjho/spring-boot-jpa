...
public class PlayerTestService {
	...
	private static void test_persist() {
		...
		try {
			...
			System.out.println("\n\n");
			transaction.commit();
			System.out.println("############### test_persist end");
        } catch (Exception ex) {
            ex.printStackTrace();
	...
	private static void test_find() {
		...
		try {
			System.out.println("############### test_find start");
			transaction.begin();
			System.out.println("\n\n");
			...
			System.out.println("\n\n");
			transaction.commit();
			System.out.println("############### test_find end");
        } catch (Exception ex) {
            ex.printStackTrace();
	...
	private static void test_change() {
		EntityManagerFactory factory = Persistence.createEntityManagerFactory("jpabegin");;
		EntityManager manager = factory.createEntityManager();
		EntityTransaction transaction = manager.getTransaction();
		
		try {
			System.out.println("############### test_change start");
			transaction.begin();
			System.out.println("\n\n");
			...
			System.out.println("\n\n");
			transaction.commit();
			System.out.println("############### test_change end");
        } catch (Exception ex) {
            ex.printStackTrace();
	...
	private static void test_remove() {
		...
		try {
			System.out.println("############### test_remove start");
			transaction.begin();
			System.out.println("\n\n");
			...
			System.out.println("\n\n");
			transaction.commit();
			System.out.println("############### test_remove end");
        } catch (Exception ex) {
            ex.printStackTrace();
